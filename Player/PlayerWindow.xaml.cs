...
public partial class PlayerWindow : Window
{
    ...
    {
        Log($"ToggleFullscreen | Antes: WindowState={WindowState}, IsFullscreen={_viewModel.IsFullscreen}");
        ...
        PosicionarControles();
        ShowControls();
        Log($"ToggleFullscreen | Depois: WindowState={WindowState}, IsFullscreen={_viewModel.IsFullscreen}");
    }
}
